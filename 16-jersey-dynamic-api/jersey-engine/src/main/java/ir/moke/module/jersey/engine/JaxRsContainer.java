...
public class JaxRsContainer {
    ...
    public void start() {
        ...
        ResourceConfigProvider.instance.register(provider);
        httpServer = GrizzlyHttpServerFactory.createHttpServer(URI.create("http://0.0.0.0:8080"), ResourceConfigProvider.instance.getResourceConfig());
        try {
